    ...
    return (
        <section className="header-banner h-96 w-full bg-yellow-50">
            <div className="flex flex-col items-center justify-center h-full">
                <h1 className="text-center text-3xl md:text-4xl lg:text-5xl poppins font-semibold text-white">Welcome to Nature Tourism</h1>

                <div className="rounded-full p-1 box-border mt-20 bg-white overflow-hidden ring-red-300 focus:ring-4 w-96 flex items-center">
